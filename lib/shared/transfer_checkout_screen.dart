...
class TransferCheckoutscreen extends StatefulWidget {
  ...
  TransferCheckoutscreen(
      ...
      this.text1});
  @override
  _TransferCheckoutscreenState createState() => _TransferCheckoutscreenState();
}
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    createSingleItem(
                        "charges",
                        '${widget.symbol}${formatPrice(widget.chargeInOtherCurrency)}',
                        Colors.black),
                    SizedBox(
                      height: 20,
                    ),
                    ...
                    createSingleItem(
                        "Total amount",
                        '${widget.symbol}${formatPrice(widget.otherCurrencyTotalAmountToSend)}',
                        Colors.black),
                  ],
                ),
              ),
