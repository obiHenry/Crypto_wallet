...
import 'package:Crypto_wallet/screens/utility_sub_screen.dart';
...
import 'bet_sub_screen.dart';
import 'cable_sub_sreen.dart';
import 'data_sub_screen.dart';
import 'dart:math';
                      ...
                      if (user.containsKey('userName')) {
                        ...
                        getCurrencies.refreshCurrencies().then((value) {
                          ...
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) => AirtimeSubScreen(
                      ...
                      if (user.containsKey('userName')) {
                        ...
                        getCurrencies.refreshCurrencies().then((value) {
                          ...
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) => CableSubScreen(
                                walletList: walletList,
                              ),
                            ),
                          );
