...
import 'package:Crypto_wallet/screens_component/cable_sub_component/body.dart';
...
class CableSubScreen extends StatefulWidget {
  final walletList;
  CableSubScreen({this.walletList});
  @override
  _CableSubScreenState createState() => _CableSubScreenState();
}
